import { handler } from '@event/listEvents/listEvents'
import { AppSyncResolverEvent, Context } from 'aws-lambda'
import { QueryListEventsArgs } from 'src/types/generated/graphql'

const callback = () => {}

const event: AppSyncResolverEvent<QueryListEventsArgs> = {
  arguments: {
    input: {},
  },
  identity: {
