import { handler } from '@event/updateEvent/updateEvent'
import { AppSyncResolverEvent, Context } from 'aws-lambda'
import { MutationUpdateEventArgs } from 'src/types/generated/graphql'

const callback = () => {}

const event: AppSyncResolverEvent<MutationUpdateEventArgs> = {
  arguments: {
    input: {
